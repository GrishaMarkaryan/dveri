...
export default function Footer() {
    return (
        <div className="flex flex-col w-full text-base items-center bg-stone-200 h-fit py-6">
            <div className="flex flex-col md:flex-row  gap-7 md:gap-28 items-start md:items-center">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <div className="text-base"> ул. Дружбы, 14А, 2 этаж </div>
                    </div>
                </div>
            ...
            <div className="font-bold text-lg p-3 mt-4"> ДВЕРНАЯ ЯРМАРКА </div>
